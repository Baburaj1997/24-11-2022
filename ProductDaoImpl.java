...
public class ProductDaoImpl implements ProductDao {
	...
	public Product getById(int id) {
		...
		String query = "select id, name,  price, unit, discontinued from product where id = ?";
	...
	public Product getByName(String name) {
		...
		String query = "select id, name, price, unit, discontinued from product where name like '?%' ";
	...
	public List<Product> getByNames(String substring) {
		...
		String query = "select id, name, price, unit, discontinued from product where price between ? and ?";
	...
	public List<Product> getByBetweenPrice(double iPrice, double oPrice) {
		...
		String query = "select id, name, price, unit, discontinued from product where disconitinued = true";
